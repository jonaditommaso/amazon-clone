        ...
        <div className="home"> 
            ...
            <div className="home__row">
                ...
                <Product
                    ...
                    subtitle=" Kenwood kMix Stand Mixer for Baking, Stylish Kitchen, Dough Hook and Whisk, 5 Litre Glass Bowl"
                    price={239.0}
                    rating={4}
            ...
            <div className="home__row">
                <Product
                    ...
                    subtitle=" LC49RG90SSUXEN Gaming - Super Ultra Wide Dual WQHD 5120 x 1440"
                    price={1094.98}
                    rating={4}
